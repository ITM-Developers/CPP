...
private:
    ...
    T **matrix;
    bool isValidIndex(size_t COL, size_t ROW);
public:
    ...
    void print();
    void reflejarEjeVertical();

    bool esSimetricaEjeVertical();
    bool esSimetricaEjeHorizontal();
    bool esSimetricaEjeDiagonalIzq();
    bool esSimetricaEjeDiagonalDer();
...
Matriz2D<T>::~Matriz2D()
{
    ...
    delete[] this->matrix;                          // Borramos la fila de la matriz
}
 ...
 *
 * @param COL
 * indice de la columna en donde se debe insertar el dato, Los indices comienzan en 0.
 *
 * @param ROW
 * Indice de la fila donde se desea insertar el dato, los indices comienzan en 0.
 *
 * @return bool
 * retorna verdadero si se inserta el dato correctamente , falso en caso de error, esto implica
 * errores de intentar acceder mas alla de las filas o columnas disponibles.
 */
template <class T>
 ...
 * Imprime todos los elementos de la matriz bidimensional
 */
template <class T>
...
/**
 * ===============================================================================================
 * @brief Matriz2D::esSimetricaEjeVertical
 * @return
 */
template <class T>
bool Matriz2D<T>::esSimetricaEjeVertical()
{
//PENDIENTE
}
...
/**
 * ===============================================================================================
 * @brief Matriz2D::esSimetricaEjeHorizontal
 * @return
 */
template <class T>
bool Matriz2D<T>::esSimetricaEjeHorizontal()
{
//PENDIENTE
}
...
/**
 * ===============================================================================================
 * @brief Matriz2D::esSimetricaEjeDiagonalIzq
 * @return
 */
template <class T>
bool Matriz2D<T>::esSimetricaEjeDiagonalIzq()
{
//PENDIENTE
}
...
/**
 * ===============================================================================================
 * @brief Matriz2D::esSimetricaEjeDiagonalDer
 * @return
 */
template <class T>
bool Matriz2D<T>::esSimetricaEjeDiagonalDer()
{
//PENDIENTE
}
...
template <class T>
void Matriz2D<T>::reflejarEjeVertical()
{
    T tmp_value;
