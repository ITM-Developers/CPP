...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_cave_out", "\\\\.\\pipe\\libinteractive_cave_cave_out" },
	{ "\\\\.\\pipe\\libinteractive_cave_cave_in", "\\\\.\\pipe\\libinteractive_Main_cave_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\cave\\cave.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\cave\\cave_debug.exe\" \"--print-ready\"",
};
